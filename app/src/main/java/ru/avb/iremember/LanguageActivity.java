...
public class LanguageActivity extends AppCompatActivity implements DialogOkCancel.OnCompleteListener {
    ...
    public class LanguageAdapter extends RecyclerView.Adapter<LanguageAdapter.MyHolder> {
        ...
        public void setData(List<Language> languages) {this.languages = languages; G.Log("Language.setData..");}
        ...
        public void onBindViewHolder(final MyHolder holder, final int position) {
            G.Log("Language.onBind.. pos="+position);
